class  Verifier2
{
  ...
  { 
   ...
   void get_next_bits(from_PB_ from_P0[], from_PB_ from_P1[], from_P2 &from_P2_to_P0, from_P2 &from_P2_to_P1,  bool L0_shares[2], bool R0_shares[2], bool L1_shares[2], bool R1_shares[2], size_t cur_depth);
  
  template<typename prgkey_t>
   auto prg_mpc(from_PB_ from_P0[], from_PB_ from_P1[], const prgkey_t & key,block_t seedL, block_t seedR,  const block_t blind0[rounds], const block_t blind1[rounds], block_t gamma[2][rounds], size_t cur_depth, size_t from, size_t len, bool LR);
   
   template<typename prgkey_t>
   void expand_mpc(from_PB_ from_P0[], from_PB_ from_P1[], from_P2 &from_P2_to_P0, from_P2 &from_P2_to_P1,  const prgkey_t & key,   block_t & seed0,  block_t & seed1,  block_t s0[2], uint8_t t0[2], 
                         block_t s1[2], uint8_t t1[2],   const block_t blind0[],  const block_t blind1[], block_t gamma[2][rounds], size_t cur_depth, bool LR);
  
   void conditional_swap_and_next_seed(from_PB_ from_P0[], from_PB_ from_P1[], from_P2 &from_P2_to_P0, from_P2 &from_P2_to_P1,  const prgkey_t & key, block_t L0_shares[2], block_t R0_shares[2], block_t L1_shares[2], block_t R1_shares[2], block_t left_out[2], block_t right_out[2], size_t cur_depth);
   
   template<typename leaf_t, typename node_t, typename prgkey_t>
   void middle_layers(from_PB_ from_P0[], from_PB_ from_P1[], from_P2 &from_P2_to_P0, from_P2 &from_P2_to_P1,  const prgkey_t& key, dpf_key<leaf_t, node_t, prgkey_t> dpfkey0, dpf_key<leaf_t, node_t, prgkey_t> dpfkey1, size_t cur_depth);  

   template<typename leaf_t, typename node_t, typename prgkey_t>
   void leaf_layer(from_PB_ from_P0[], from_PB_ from_P1[], from_P2 &from_P2_to_P0, from_P2 &from_P2_to_P1,  const prgkey_t& key, dpf_key<leaf_t, node_t, prgkey_t> dpfkey0, dpf_key<leaf_t, node_t, prgkey_t> dpfkey1, size_t cur_depth);  


   template<typename T>
   void multiply_mpc(from_PB_ from_P0[], from_PB_ from_P1[], from_P2 &from_P2_to_P0, from_P2 &from_P2_to_P1,  const T&, bool, const T&, bool, T results[2], size_t mul, size_t cur_depth);
   void multiply_mpc_b(from_PB_ from_P0[], from_PB_ from_P1[], from_P2 &from_P2_to_P0, from_P2 &from_P2_to_P1,  const bool& x0, bool b0, const bool& x1, bool b1, bool results[2], size_t mul, size_t cur_depth);
   void multiply_mpc(from_PB_ from_P0[], from_PB_ from_P1[], from_P2 &from_P2_to_P0, from_P2 &from_P2_to_P1,  const bool& x0, bool b0, const bool& x1, bool b1, bool results[2], size_t mul, size_t cur_depth);
   // void dpf_mpc(LowMC&, AES_KEY&, dpf_key<__mX, nitems>& k0, dpf_key<__mX, nitems> k1); 
   template<typename leaf_t, typename node_t, typename prgkey_t>
   void root_layer(from_PB_ from_P0[], from_PB_ from_P1[], from_P2 &from_P2_to_P0, from_P2 &from_P2_to_P1,  const prgkey_t& key, dpf_key<leaf_t, node_t, prgkey_t> dpfkey0, dpf_key<leaf_t, node_t, prgkey_t> dpfkey1);
...
//private:
  ...
  void Verifier2::Gen_Blinds(block_t blinds0[rounds], block_t blinds1[rounds], block_t gamma[2][rounds])
  {
    block_t rand[rounds];
    ...
    void Verifier2::multiply_mpc_b(from_PB_ from_P0[], from_PB_ from_P1[], from_P2 &from_P2_to_P0, from_P2 &from_P2_to_P1,  const bool& x0, bool b0, const bool& x1, bool b1, bool results[2], size_t mul, size_t cur_depth)
  {
    ...
    from_P0[cur_depth].next_bit_L_recv[mul] = x0 ^ D0;
    from_P0[cur_depth].next_bit_R_recv[mul] = b0 ^ d0;

    from_P1[cur_depth].next_bit_L_recv[mul] = x1 ^ D1;
    from_P1[cur_depth].next_bit_R_recv[mul] = b1 ^ d1;

    const bool gamma0 = xor_if(c0, from_P1[cur_depth].next_bit_L_recv[mul], d0);
    bool xx0 = x0;   
 

    const bool gamma1 = xor_if(c1, from_P0[cur_depth].next_bit_L_recv[mul], d1);
    bool xx1 = x1;  
  
    results[0] = xor_if(gamma0, xx0, (b0 ^ from_P1[cur_depth].next_bit_R_recv[mul]));
  
    results[1] = xor_if(gamma1, xx1, (b1 ^ from_P0[cur_depth].next_bit_R_recv[mul])); 
  }


  void Verifier2::get_next_bits(from_PB_ from_P0[], from_PB_ from_P1[], from_P2 &from_P2_to_P0, from_P2 &from_P2_to_P1,  bool bit0_L[2], bool bit0_R[2], bool bit1_L[2], bool bit1_R[2], size_t cur_depth)
  {
 ...
 void Verifier2::multiply_mpc(from_PB_ from_P0[], from_PB_ from_P1[], from_P2 &from_P2_to_P0, from_P2 &from_P2_to_P1,  const bool& x0, bool b0, const bool& x1, bool b1, bool results[2], size_t mul, size_t cur_depth)
  {

    //std::cout << "Verifier2:::multiply_mpc, cur_depth = " << cur_depth << std::endl; 
    ...
    from_P0[cur_depth].next_bit_L_recv2[mul] = x0 ^ D0;
   // std::cout << "sim: x0 ^ D0 = " << x0 << " ^ " << D0 << std::endl;
    from_P0[cur_depth].next_bit_R_recv2[mul] = b0 ^ d0;

 

    from_P1[cur_depth].next_bit_L_recv2[mul] = x1 ^ D1;
   //  std::cout << "sim: x1 ^ D1 = " << x1 << " ^ " << D1 << std::endl;
    from_P1[cur_depth].next_bit_R_recv2[mul] = b1 ^ d1;


      const bool gamma0 = xor_if(c0, from_P1[cur_depth].next_bit_L_recv2[mul], d0);
  
    bool xx0 = x0;   
    
    
    const bool gamma1 = xor_if(c1, from_P0[cur_depth].next_bit_L_recv2[mul], d1);
   
    bool xx1 = x1;  
   
    results[0] = xor_if(gamma0, xx0, (b0 ^ from_P1[cur_depth].next_bit_R_recv2[mul]));
  
    results[1] = xor_if(gamma1, xx1, (b1 ^ from_P0[cur_depth].next_bit_R_recv2[mul])); 
  ...
  template<typename T>
  void Verifier2::multiply_mpc(from_PB_ from_P0[], from_PB_ from_P1[], from_P2 &from_P2_to_P0, from_P2 &from_P2_to_P1,  const T& x0, bool b0, const T& x1, bool b1, T results[2], size_t mul, size_t cur_depth)
  {   
    ...
    from_P0[cur_depth].blinds_recv[mul]    = x0 ^ D0;
    from_P0[cur_depth].bit_blinds_recv[mul] = b0 ^ d0;
 
    from_P1[cur_depth].blinds_recv[mul]     = x1 ^ D1;    
    from_P1[cur_depth].bit_blinds_recv[mul] = b1 ^ d1;

    const T gamma0 = xor_if(c0, from_P1[cur_depth].blinds_recv[mul], d0);

    T xx0 = x0;

    const T gamma1 = xor_if(c1, from_P0[cur_depth].blinds_recv[mul], d1);
    
    T xx1 = x1;

    results[0] = xor_if(gamma0, xx0, (b0 ^ from_P1[cur_depth].bit_blinds_recv[mul])); 
    results[1] = xor_if(gamma1, xx1, (b1 ^ from_P0[cur_depth].bit_blinds_recv[mul])); 
  }

template<typename prgkey_t>
inline auto Verifier2::prg_mpc(from_PB_ from_P0[], from_PB_ from_P1[], const prgkey_t& key, block_t seedL, block_t seedR,  const block_t blind0[rounds], const block_t blind1[rounds], block_t gamma[2][rounds], size_t cur_depth, size_t from, size_t len, bool LR)
{    
  ...
  //for(size_t i = 0; i < len; ++i)
  {
    ...
    block_t outL[rounds+1], outR[rounds+1];

    auto encrypt_outL =  key.encrypt_MPC_proof(tmp0, tmp1, blind0, blind1, gamma, outL, outR);
    if(!LR)
    {

     for(size_t r = 0; r <= rounds; ++r)
     {
      from_P1[cur_depth].seed0L_encrypt[r] = outR[r];
      from_P0[cur_depth].seed0L_encrypt[r] = outL[r];
     }
    ...
    for(size_t r = 0; r <= rounds; ++r)
     {
      from_P1[cur_depth].seed1L_encrypt[r] = outR[r];
      from_P0[cur_depth].seed1L_encrypt[r] = outL[r];
     }
     // from_P1.vals.seed1L_encrypt[cur_depth] = encrypt_outL.second; 
     // from_P0.vals.seed1L_encrypt[cur_depth] = encrypt_outL.first; 
    }
    ...
    tmp1 = seed1_;
    auto encrypt_outR =  key.encrypt_MPC_proof(tmp0, tmp1, blind0, blind1, gamma, outL, outR);
    ...
    if(!LR)
    {
     ...
     for(size_t r = 0; r <= rounds; ++r)
     {
      from_P1[cur_depth].seed0R_encrypt[r] = outR[r];
      from_P0[cur_depth].seed0R_encrypt[r] = outL[r];
     }
    // from_P1.vals.seed0R_encrypt[cur_depth] = encrypt_outR.second;
    // from_P0.vals.seed0R_encrypt[cur_depth] = encrypt_outR.first; 
    ...
    if(LR)
    {
      for(size_t r = 0; r <= rounds; ++r)
     {
      from_P1[cur_depth].seed1R_encrypt[r] = outR[r];
      from_P0[cur_depth].seed1R_encrypt[r] = outL[r];
      }
    // from_P1.vals.seed1R_encrypt[cur_depth] = encrypt_outR.second;     
    // from_P0.vals.seed1R_encrypt[cur_depth] = encrypt_outR.first;
    }
  ...
  template<typename prgkey_t>
 inline void Verifier2::expand_mpc(from_PB_ from_P0[], from_PB_ from_P1[], from_P2 &from_P2_to_P0, from_P2 &from_P2_to_P1, const prgkey_t & key,  block_t & seed0,  block_t & seed1,  block_t s0[2], uint8_t t0[2], 
                        block_t s1[2], uint8_t t1[2],   const block_t blind0[rounds],   const block_t blind1[rounds], block_t gamma[2][rounds], size_t cur_depth, bool LR)
 {
   ...
   std::vector<block_t> c1(2 + rounds + rounds);
    ...
    auto prg_out = prg_mpc(from_P0, from_P1, key, seed0, seed1, blind0, blind1, gamma,  cur_depth, 0, 2, LR);
    ...
    // if(!LR)
    // {
    //  from_P1.vals.seed0L_encrypt[cur_depth] = encrypt_outL.second;
  
    //  from_P0.vals.seed0L_encrypt[cur_depth] = encrypt_outL.first;
   ...
   void Verifier2::conditional_swap_and_next_seed(from_PB_ from_P0[], from_PB_ from_P1[], from_P2 &from_P2_to_P0, from_P2 &from_P2_to_P1, const prgkey_t& key, block_t s0_L[2], block_t s0_R[2], block_t s1_L[2], block_t s1_R[2], block_t left_out[2], block_t right_out[2], size_t cur_depth)
  {
  ...
  template<typename leaf_t, typename node_t, typename prgkey_t>
  void Verifier2::root_layer(from_PB_ from_P0[], from_PB_ from_P1[], from_P2 &from_P2_to_P0, from_P2 &from_P2_to_P1, const prgkey_t & prgkey, dpf_key<leaf_t, node_t, prgkey_t> dpfkey0, dpf_key<leaf_t, node_t, prgkey_t> dpfkey1)
  {
    ...
    from_P1[cur_depth].L_shares_recv = s1_L[0];
    from_P1[cur_depth].R_shares_recv = s1_R[0];

 
    from_P0[cur_depth].L_shares_recv = s0_L[1];
    from_P0[cur_depth].R_shares_recv = s0_R[1];
    ...
    from_P1[cur_depth].bit_L_shares_recv = bit1_L[0];
    from_P1[cur_depth].bit_R_shares_recv = bit1_R[0];
 
    from_P0[cur_depth].bit_L_shares_recv = bit0_L[1];
    from_P0[cur_depth].bit_R_shares_recv = bit0_R[1];
  ...
  template<typename leaf_t, typename node_t, typename prgkey_t>
  void Verifier2::middle_layers(from_PB_ from_P0[], from_PB_ from_P1[], from_P2 &from_P2_to_P0, from_P2 &from_P2_to_P1, const prgkey_t& key, dpf_key<leaf_t, node_t, prgkey_t> dpfkey0, dpf_key<leaf_t, node_t, prgkey_t> dpfkey1, size_t cur_depth) 
  {
    ...
    uint8_t t0[2], t1[2], t_[2];    
      ...
      block_t seed0L_ = clear_lsb(seed0[cur_depth][0], 0b11);
      block_t seed0R_ = clear_lsb(seed0[cur_depth][1], 0b11);
    ...
    if(cur_depth == depth - 1)
    {
      ...
      for(size_t j = 0; j < dpfkey0.nodes_per_leaf; ++j)
      {
         ...
         from_P0[cur_depth].final = seed0[cur_depth+1][0] ^ seed1[cur_depth+1][0];
         from_P1[cur_depth].final = seed0[cur_depth+1][1] ^ seed1[cur_depth+1][1];
      }

      block_t final_out = (seed0[cur_depth+1][0] ^ seed0[cur_depth+1][1] ^ seed1[cur_depth+1][0] ^ seed1[cur_depth+1][1]);
      std::cout << " -> [Verifier2]: " << final_out.bits << std::endl;
    }    
 }
 ...
 template<typename leaf_t, typename node_t, typename prgkey_t>
  void Verifier2::leaf_layer(from_PB_ from_P0[], from_PB_ from_P1[], from_P2 &from_P2_to_P0, from_P2 &from_P2_to_P1, const prgkey_t& key, dpf_key<leaf_t, node_t, prgkey_t> dpfkey0, dpf_key<leaf_t, node_t, prgkey_t> dpfkey1, size_t cur_depth) 
  {
